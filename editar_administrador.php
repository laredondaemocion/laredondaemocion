...
<html>
	...
	<body>
		...
		method="POST" action="confirmacion_edicion_administrador.php"  onsubmit="refresh();">
			...
			<h2 class="text-center">Editar Datos</h2>
				<div class="row">
				    <input type="hidden" name="rut" <?php echo "value='".$_SESSION['rut']."'"?>>	
				      	<?php 
				      	$rut=$_SESSION['rut'];
				      	$resultado=mysqli_query($conexion,"CALL datos_administrador_por_rut($rut)");
				      	if ($row=mysqli_fetch_array($resultado)) {
				      			echo "	<input type='hidden' name='rut' value='$rut'>
										...
										<div class='form-group form-group-sm'>
												...
												<div class='col-sm-4'>
													<input type='text' class='form-control' name='nombre' id='nombre' value='$row[nombre_administrador]'>
												</div>
										</div>
										<div class='form-group form-group-sm'>
											...
											<div class='col-sm-6'>
												...
												<input type='email' class='form-control' name='mail' id='mail' value='$row[correo_administrador]'>
											</div>
										</div>
				      					";
					         ...
					         echo "</select>
				      		...
				      		echo "<div class='form-group form-group-sm'>
												...
												<div class='col-sm-4'></div>
												<div class='col-sm-4'>
													<input type='text' class='form-control' name='telefono' id='telefono' value='$row[telefono_administrador]'>
												</div>
										</div>";
							echo "<div class='form-group form-group-sm'>
									<div class='col-sm-12'>
