...
<html>
	...
	<body>
		...
		method="POST" action="eliminar_imagen_cancha.php" onsubmit="refresh();">
				...
				<div class="row">
					<?php
	                  ...
	                  while($resp=mysqli_fetch_array($imagenes))
	                  {
	                    ...
	                    <input type="text" value="'.$resp['direccion'].'"  name="direc[]" hidden>
	                    <input type="checkbox" value="'.$resp['idMultimedia_cancha'].'" name="borrado[]">
	                    <br>';
	                    $total_ima++;
	                  }
	                  if ($total_ima==0) {
